// Last updated: 31/07/2026, 09:50:55
1class Solution {
2    int[][] memo;
...
8        }
9
10        return f(n-1,amount,coins);
11    }
12    int f(int ind , int amount, int[] coins){
...
25
26        int notpick = f(ind-1, amount , coins);
27        int pick = 0;
28        if(coins[ind] <= amount){
29            pick = f(ind,amount - coins[ind] ,coins);
30        }
31
